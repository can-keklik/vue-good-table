...
var __vue_render__$6 = function __vue_render__() {
  ...
  return _c('div', {
    ...
    return _c('tbody', {
      ...
      })], 2), _vm._v(" "), _vm.hasDetailRows && row[_vm.rowExtensionKeys['isDetailRowShown']] ? _c('tr', {
        key: 'detail_' + row.originalIndex,
        staticClass: "vgt-detail-row"
      }, [_c('td', {
        attrs: {
          "colspan": _vm.visibleColumns.length
        }
      }, [_vm._t("table-detail-row", null, {
        "row": row,
        "index": index
      })], 2)]) : _vm._e()] : _vm._e();
